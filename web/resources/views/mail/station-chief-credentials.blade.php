...
<head>
    ...
    <title>Responde station chief account</title>
</head>
    ...
    <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
        <div style="overflow:hidden;border:1px solid #e2e8f0;border-radius:16px;background:#ffffff;">
            <div style="background:#e0752e;padding:24px 28px;color:#ffffff;">
                ...
                <div style="margin-top:4px;font-size:14px;">Station chief account</div>
            </div>

            <div style="padding:28px;">
                <p style="margin:0 0 16px;">Hello {{ $chiefName }},</p>

                <p style="margin:0 0 20px;line-height:1.6;">
                    You were assigned as the chief of
                    <strong>{{ $stationName }}</strong> under
